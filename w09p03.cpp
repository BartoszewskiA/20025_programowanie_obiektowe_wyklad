...
public:
    ...
    student(string im = "", string nazw = "", string k = "", string w = "") : imie(im), nazwisko(nazw), kierunek(k), wydzial(w)
    {
        ...
        *historia_studiow = "Przyjecie na studia";
    }

    student(const student &wzorzec, string im = "NN", string nazw = "NN")
    {
        Id = ++ile;
        imie = im;
        nazwisko = nazw;
    ...
    {
        stringstream temp;
        temp << "(" << Id << ") " << nazwisko << " " << imie << " Wydzial: " << wydzial << " Kierunek: " << kierunek<< endl
...
int main()
{
    ...
    student s2(kierunki[1], "Andrzej", "Nowak");
